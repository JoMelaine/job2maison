            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
              ...
              <div class=" my-2 my-lg-0">
                <ul class="navbar-nav ml-auto">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" style="color:#20123a; font-weight:700" href="/employer/read/candidate">Candidats</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" style="color:#20123a; font-weight:700" href="/employer/read/contact">Mes contacts</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" style="color:#20123a; font-weight:700" href="/employer/read/contrat">Contrats</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" style="color:#20123a; font-weight:700" href="#">Notification</a>
                    </li>
                    <li class="nav-item dropdown @if($_SERVER['REQUEST_URI'] == '/candidate/showinfo') action_url @endif">
                        ...
                        <div class="dropdown-menu shadow-lg" style="border:0" aria-labelledby="dropdownAccount">
                            <a class="dropdown-item " href="/employer/showinfo/identite">Profil</a>
